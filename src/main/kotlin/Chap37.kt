...
fun main(args: Array<String>) {
    run {
        ...
        printRandomValuesCaloulation(p)
        printRandomValuesCaloulation(m)
    }
    run{
        println("-----37.4----")
    ...
    run{
        println("----37.6----")
        val calculater1 = getCalculator("+")
        val calculater2 = getCalculator("-")
        val result1 = calculater1(10.0, 2.0)
        val result2 = calculater1(10.0, 2.0)
        println(result1)
        println(result2)
    }
}
...
fun printRandomValuesCaloulation(calculater: (Double, Double) -> Double) {
    val x = Random.nextDouble()
    val y = Random.nextDouble()
    val result = calculater(x, y)
